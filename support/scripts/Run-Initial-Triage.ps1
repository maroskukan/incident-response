# Runs initial triage on a system to determine if it is a potential incident.
...
#tcpview
./SysInternalsSuite/tcpview64.exe -accepteula
## browse to domain & ip
stop-transcript
...
#autoruns
./SysInternalsSuite/autoruns64.exe -accepteula

#scheduled tasks
schtasks

#disk information
./SysInternalsSuite/volumeid64.exe -accepteula
./SysInternalsSuite/diskmon.exe -accepteula
./SysInternalsSuite/ntfsinfo.exe -accepteula
./SysInternalsSuite/DiskView.exe -accepteula

#additonal process info
./SysInternalsSuite/listdll.exe -accepteula
./SysInternalsSuite/handle.exe -accepteula
